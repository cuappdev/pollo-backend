...
class PostDraftToCollectionRouter extends AppDevRouter<APIDraftCollection> {
  constructor() {
  ...
  async content(req: Request) {
    ...
    await DraftCollectionsRepo.addDraftByID(id, draftID, pos);
...
export default new PostDraftToCollectionRouter().router;
